            ...
            .ajaxForm({
                ...
                success: function (result) {
                    ...
                    if (result == 'MF000') {
                        ...
                        document.location.replace("http://ssintez.com/thanks.html");
    ...
    Progress.prototype.watch = function () {
        ...
        self._core.$element
            .on('mf.process', function () {
                $(this).find('.' + self._core.options.progress.class).removeClass('hide').addClass('sending').find('.msg').text('Отправка...');
            })
